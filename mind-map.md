...
Generated: 2025-09-06 15:26 UTC
...
- rtrg
  ...
  - core
    ...
    - registry_factory.py
      - functions: `create_registry_for_context`, `create_auto_registry`, `get_registry_factory`
      - classes: `RegistryContext`, `ContextDetector`, `RegistryFactory`
    - tensors.py
