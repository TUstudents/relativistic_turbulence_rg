...
from rtrg.core.tensors import Metric, IndexStructure, LorentzTensor
...
class TestIndexStructure:
    ...
    def test_index_structure_creation(self):
        ...
        assert indices.is_symmetric() == True
...
class TestLorentzTensor:
    ...
    def setup_method(self):
        ...
        g_indices = IndexStructure(['mu', 'nu'], ['covariant', 'covariant'], ['symmetric', 'symmetric'])
...
class TestPhysicalInvariants:
    ...
    def test_energy_momentum_conservation(self):
        ...
        energy_density = np.einsum('mu,mu', T, np.outer(u_covariant, u_covariant)) / PhysicalConstants.c**2
...
class TestTensorPerformance:
    ...
    def test_symmetrization_performance(self, benchmark):
        ...
        indices = IndexStructure(['mu', 'nu', 'rho'], ['covariant', 'covariant', 'covariant'], ['none', 'none', 'none'])
